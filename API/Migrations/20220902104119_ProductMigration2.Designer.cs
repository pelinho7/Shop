...
namespace API.Migrations
{
    ...
    [Migration("20220902104119_ProductMigration2")]
            ...
            modelBuilder.Entity("API.DBAccess.Entities.Agreement", b =>
                {
                    ...
                    b.Property<DateTime>("ModDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2022, 9, 2, 10, 41, 18, 737, DateTimeKind.Utc).AddTicks(8060));
            ...
            modelBuilder.Entity("API.DBAccess.Entities.AppUserHistory", b =>
                {
                    ...
                    b.Property<DateTime>("ModDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2022, 9, 2, 10, 41, 18, 736, DateTimeKind.Utc).AddTicks(5187));
            ...
            modelBuilder.Entity("API.DBAccess.Entities.Attribute", b =>
                {
                    ...
                    b.Property<DateTime>("ModDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2022, 9, 2, 10, 41, 18, 738, DateTimeKind.Utc).AddTicks(939));
            ...
            modelBuilder.Entity("API.DBAccess.Entities.AttributeHistory", b =>
                {
                    ...
                    b.Property<DateTime>("ModDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2022, 9, 2, 10, 41, 18, 738, DateTimeKind.Utc).AddTicks(1468));
            ...
            modelBuilder.Entity("API.DBAccess.Entities.Category", b =>
                {
                    ...
                    b.Property<DateTime>("ModDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2022, 9, 2, 10, 41, 18, 738, DateTimeKind.Utc).AddTicks(1977));
            ...
            modelBuilder.Entity("API.DBAccess.Entities.CategoryAttribute", b =>
                {
                    ...
                    b.Property<DateTime>("ModDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2022, 9, 2, 10, 41, 18, 738, DateTimeKind.Utc).AddTicks(2484));
            ...
            modelBuilder.Entity("API.DBAccess.Entities.CategoryAttributeHistory", b =>
                {
                    ...
                    b.Property<DateTime>("ModDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2022, 9, 2, 10, 41, 18, 738, DateTimeKind.Utc).AddTicks(3520));
            ...
            modelBuilder.Entity("API.DBAccess.Entities.CategoryHistory", b =>
                {
                    ...
                    b.Property<DateTime>("ModDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2022, 9, 2, 10, 41, 18, 738, DateTimeKind.Utc).AddTicks(2946));
            ...
            modelBuilder.Entity("API.DBAccess.Entities.Discount", b =>
                {
                    ...
                    b.Property<DateTime>("ModDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2022, 9, 2, 10, 41, 18, 738, DateTimeKind.Utc).AddTicks(5105));
            ...
            modelBuilder.Entity("API.DBAccess.Entities.ProductAmount", b =>
                {
                    ...
                    b.Property<DateTime>("ModDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2022, 9, 2, 10, 41, 18, 738, DateTimeKind.Utc).AddTicks(4636));
            ...
            modelBuilder.Entity("API.DBAccess.Entities.ShippingAddress", b =>
                {
                    ...
                    b.Property<DateTime>("ModDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2022, 9, 2, 10, 41, 18, 737, DateTimeKind.Utc).AddTicks(9795));
            ...
            modelBuilder.Entity("API.DBAccess.Entities.ShippingAddressHistory", b =>
                {
                    ...
                    b.Property<DateTime>("ModDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2022, 9, 2, 10, 41, 18, 738, DateTimeKind.Utc).AddTicks(322));
            ...
            modelBuilder.Entity("API.DBAccess.Entities.UserAgreement", b =>
                {
                    ...
                    b.Property<DateTime>("ModDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2022, 9, 2, 10, 41, 18, 737, DateTimeKind.Utc).AddTicks(8683));
            ...
            modelBuilder.Entity("API.DBAccess.Entities.UserAgreementHistory", b =>
                {
                    ...
                    b.Property<DateTime>("ModDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2022, 9, 2, 10, 41, 18, 737, DateTimeKind.Utc).AddTicks(9289));
            ...
            modelBuilder.Entity("API.DBAccess.Entities.Warehouse", b =>
                {
                    ...
                    b.Property<DateTime>("ModDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2022, 9, 2, 10, 41, 18, 738, DateTimeKind.Utc).AddTicks(4088));
