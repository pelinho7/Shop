...
namespace API.Migrations
{
    ...
    [Migration("20220531175520_CategoryAttributeHistoryMigration3")]
    partial class CategoryAttributeHistoryMigration3
    {
            ...
            modelBuilder.Entity("API.DBAccess.Entities.Agreement", b =>
                {
                    ...
                    b.Property<DateTime>("ModDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2022, 5, 31, 17, 55, 20, 303, DateTimeKind.Utc).AddTicks(772));
            ...
            modelBuilder.Entity("API.DBAccess.Entities.AppUserHistory", b =>
                {
                    ...
                    b.Property<DateTime>("ModDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2022, 5, 31, 17, 55, 20, 301, DateTimeKind.Utc).AddTicks(7997));
            ...
            modelBuilder.Entity("API.DBAccess.Entities.Attribute", b =>
                {
                    ...
                    b.Property<DateTime>("ModDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2022, 5, 31, 17, 55, 20, 303, DateTimeKind.Utc).AddTicks(4830));
            ...
            modelBuilder.Entity("API.DBAccess.Entities.AttributeHistory", b =>
                {
                    ...
                    b.Property<DateTime>("ModDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2022, 5, 31, 17, 55, 20, 303, DateTimeKind.Utc).AddTicks(5308));
            ...
            modelBuilder.Entity("API.DBAccess.Entities.Category", b =>
                {
                    ...
                    b.Property<DateTime>("ModDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2022, 5, 31, 17, 55, 20, 303, DateTimeKind.Utc).AddTicks(5890));
            ...
            modelBuilder.Entity("API.DBAccess.Entities.CategoryAttribute", b =>
                {
                    ...
                    b.Property<DateTime>("ModDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2022, 5, 31, 17, 55, 20, 303, DateTimeKind.Utc).AddTicks(6413));
            ...
            modelBuilder.Entity("API.DBAccess.Entities.CategoryAttributeHistory", b =>
                {
                    ...
                    b.Property<DateTime>("ModDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2022, 5, 31, 17, 55, 20, 303, DateTimeKind.Utc).AddTicks(7395));
            ...
            modelBuilder.Entity("API.DBAccess.Entities.CategoryHistory", b =>
                {
                    ...
                    b.Property<DateTime>("ModDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2022, 5, 31, 17, 55, 20, 303, DateTimeKind.Utc).AddTicks(6885));
            ...
            modelBuilder.Entity("API.DBAccess.Entities.ShippingAddress", b =>
                {
                    ...
                    b.Property<DateTime>("ModDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2022, 5, 31, 17, 55, 20, 303, DateTimeKind.Utc).AddTicks(3739));
            ...
            modelBuilder.Entity("API.DBAccess.Entities.ShippingAddressHistory", b =>
                {
                    ...
                    b.Property<DateTime>("ModDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2022, 5, 31, 17, 55, 20, 303, DateTimeKind.Utc).AddTicks(4236));
            ...
            modelBuilder.Entity("API.DBAccess.Entities.UserAgreement", b =>
                {
                    ...
                    b.Property<DateTime>("ModDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2022, 5, 31, 17, 55, 20, 303, DateTimeKind.Utc).AddTicks(1838));
            ...
            modelBuilder.Entity("API.DBAccess.Entities.UserAgreementHistory", b =>
                {
                    ...
                    b.Property<DateTime>("ModDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2022, 5, 31, 17, 55, 20, 303, DateTimeKind.Utc).AddTicks(2990));
