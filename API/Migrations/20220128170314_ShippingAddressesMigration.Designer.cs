...
namespace API.Migrations
{
    ...
    [Migration("20220128170314_ShippingAddressesMigration")]
    partial class ShippingAddressesMigration
    {
            ...
            modelBuilder.Entity("API.DBAccess.Entities.Agreement", b =>
                {
                    ...
                    b.Property<DateTime>("ModDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2022, 1, 28, 17, 3, 14, 200, DateTimeKind.Utc).AddTicks(9069));
            ...
            modelBuilder.Entity("API.DBAccess.Entities.AppUserHistory", b =>
                {
                    ...
                    b.Property<DateTime>("ModDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2022, 1, 28, 17, 3, 14, 199, DateTimeKind.Utc).AddTicks(5350));
            ...
            modelBuilder.Entity("API.DBAccess.Entities.ShippingAddress", b =>
                {
                    ...
                    b.Property<DateTime>("ModDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2022, 1, 28, 17, 3, 14, 201, DateTimeKind.Utc).AddTicks(941));
            ...
            modelBuilder.Entity("API.DBAccess.Entities.UserAgreement", b =>
                {
                    ...
                    b.Property<DateTime>("ModDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2022, 1, 28, 17, 3, 14, 200, DateTimeKind.Utc).AddTicks(9789));
            ...
            modelBuilder.Entity("API.DBAccess.Entities.UserAgreementHistory", b =>
                {
                    ...
                    b.Property<DateTime>("ModDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2022, 1, 28, 17, 3, 14, 201, DateTimeKind.Utc).AddTicks(322));
