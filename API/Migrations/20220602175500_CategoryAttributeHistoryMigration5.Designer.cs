...
namespace API.Migrations
{
    ...
    [Migration("20220602175500_CategoryAttributeHistoryMigration5")]
    partial class CategoryAttributeHistoryMigration5
    {
            ...
            modelBuilder.Entity("API.DBAccess.Entities.Agreement", b =>
                {
                    ...
                    b.Property<DateTime>("ModDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2022, 6, 2, 17, 55, 0, 587, DateTimeKind.Utc).AddTicks(1012));
            ...
            modelBuilder.Entity("API.DBAccess.Entities.AppUserHistory", b =>
                {
                    ...
                    b.Property<DateTime>("ModDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2022, 6, 2, 17, 55, 0, 585, DateTimeKind.Utc).AddTicks(7754));
            ...
            modelBuilder.Entity("API.DBAccess.Entities.Attribute", b =>
                {
                    ...
                    b.Property<DateTime>("ModDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2022, 6, 2, 17, 55, 0, 587, DateTimeKind.Utc).AddTicks(3939));
            ...
            modelBuilder.Entity("API.DBAccess.Entities.AttributeHistory", b =>
                {
                    ...
                    b.Property<DateTime>("ModDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2022, 6, 2, 17, 55, 0, 587, DateTimeKind.Utc).AddTicks(4570));
            ...
            modelBuilder.Entity("API.DBAccess.Entities.Category", b =>
                {
                    ...
                    b.Property<DateTime>("ModDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2022, 6, 2, 17, 55, 0, 587, DateTimeKind.Utc).AddTicks(5056));
            ...
            modelBuilder.Entity("API.DBAccess.Entities.CategoryAttribute", b =>
                {
                    ...
                    b.Property<DateTime>("ModDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2022, 6, 2, 17, 55, 0, 587, DateTimeKind.Utc).AddTicks(5619));
            ...
            modelBuilder.Entity("API.DBAccess.Entities.CategoryAttributeHistory", b =>
                {
                    ...
                    b.Property<DateTime>("ModDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2022, 6, 2, 17, 55, 0, 587, DateTimeKind.Utc).AddTicks(6660));
            ...
            modelBuilder.Entity("API.DBAccess.Entities.CategoryHistory", b =>
                {
                    ...
                    b.Property<DateTime>("ModDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2022, 6, 2, 17, 55, 0, 587, DateTimeKind.Utc).AddTicks(6102));
            ...
            modelBuilder.Entity("API.DBAccess.Entities.ShippingAddress", b =>
                {
                    ...
                    b.Property<DateTime>("ModDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2022, 6, 2, 17, 55, 0, 587, DateTimeKind.Utc).AddTicks(2795));
            ...
            modelBuilder.Entity("API.DBAccess.Entities.ShippingAddressHistory", b =>
                {
                    ...
                    b.Property<DateTime>("ModDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2022, 6, 2, 17, 55, 0, 587, DateTimeKind.Utc).AddTicks(3330));
            ...
            modelBuilder.Entity("API.DBAccess.Entities.UserAgreement", b =>
                {
                    ...
                    b.Property<DateTime>("ModDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2022, 6, 2, 17, 55, 0, 587, DateTimeKind.Utc).AddTicks(1740));
            ...
            modelBuilder.Entity("API.DBAccess.Entities.UserAgreementHistory", b =>
                {
                    ...
                    b.Property<DateTime>("ModDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2022, 6, 2, 17, 55, 0, 587, DateTimeKind.Utc).AddTicks(2306));
