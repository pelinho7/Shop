...
namespace API.Migrations
{
    ...
    [Migration("20220531180451_CategoryAttributeHistoryMigration4")]
    partial class CategoryAttributeHistoryMigration4
    {
            ...
            modelBuilder.Entity("API.DBAccess.Entities.Agreement", b =>
                {
                    ...
                    b.Property<DateTime>("ModDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2022, 5, 31, 18, 4, 51, 216, DateTimeKind.Utc).AddTicks(8487));
            ...
            modelBuilder.Entity("API.DBAccess.Entities.AppUserHistory", b =>
                {
                    ...
                    b.Property<DateTime>("ModDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2022, 5, 31, 18, 4, 51, 215, DateTimeKind.Utc).AddTicks(4717));
            ...
            modelBuilder.Entity("API.DBAccess.Entities.Attribute", b =>
                {
                    ...
                    b.Property<DateTime>("ModDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2022, 5, 31, 18, 4, 51, 217, DateTimeKind.Utc).AddTicks(1962));
            ...
            modelBuilder.Entity("API.DBAccess.Entities.AttributeHistory", b =>
                {
                    ...
                    b.Property<DateTime>("ModDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2022, 5, 31, 18, 4, 51, 217, DateTimeKind.Utc).AddTicks(2546));
            ...
            modelBuilder.Entity("API.DBAccess.Entities.Category", b =>
                {
                    ...
                    b.Property<DateTime>("ModDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2022, 5, 31, 18, 4, 51, 217, DateTimeKind.Utc).AddTicks(3143));
            ...
            modelBuilder.Entity("API.DBAccess.Entities.CategoryAttribute", b =>
                {
                    ...
                    b.Property<DateTime>("ModDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2022, 5, 31, 18, 4, 51, 217, DateTimeKind.Utc).AddTicks(3645));
            ...
            modelBuilder.Entity("API.DBAccess.Entities.CategoryAttributeHistory", b =>
                {
                    ...
                    b.Property<DateTime>("ModDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2022, 5, 31, 18, 4, 51, 217, DateTimeKind.Utc).AddTicks(4813));
            ...
            modelBuilder.Entity("API.DBAccess.Entities.CategoryHistory", b =>
                {
                    ...
                    b.Property<DateTime>("ModDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2022, 5, 31, 18, 4, 51, 217, DateTimeKind.Utc).AddTicks(4299));
            ...
            modelBuilder.Entity("API.DBAccess.Entities.ShippingAddress", b =>
                {
                    ...
                    b.Property<DateTime>("ModDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2022, 5, 31, 18, 4, 51, 217, DateTimeKind.Utc).AddTicks(713));
            ...
            modelBuilder.Entity("API.DBAccess.Entities.ShippingAddressHistory", b =>
                {
                    ...
                    b.Property<DateTime>("ModDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2022, 5, 31, 18, 4, 51, 217, DateTimeKind.Utc).AddTicks(1298));
            ...
            modelBuilder.Entity("API.DBAccess.Entities.UserAgreement", b =>
                {
                    ...
                    b.Property<DateTime>("ModDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2022, 5, 31, 18, 4, 51, 216, DateTimeKind.Utc).AddTicks(9332));
            ...
            modelBuilder.Entity("API.DBAccess.Entities.UserAgreementHistory", b =>
                {
                    ...
                    b.Property<DateTime>("ModDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2022, 5, 31, 18, 4, 51, 217, DateTimeKind.Utc).AddTicks(57));
