...
namespace API.Migrations
{
    ...
    [Migration("20220901172216_DiscountMigration2")]
    partial class DiscountMigration2
    {
            ...
            modelBuilder.Entity("API.DBAccess.Entities.Agreement", b =>
                {
                    ...
                    b.Property<DateTime>("ModDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2022, 9, 1, 17, 22, 16, 402, DateTimeKind.Utc).AddTicks(2081));
            ...
            modelBuilder.Entity("API.DBAccess.Entities.AppUserHistory", b =>
                {
                    ...
                    b.Property<DateTime>("ModDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2022, 9, 1, 17, 22, 16, 400, DateTimeKind.Utc).AddTicks(9708));
            ...
            modelBuilder.Entity("API.DBAccess.Entities.Attribute", b =>
                {
                    ...
                    b.Property<DateTime>("ModDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2022, 9, 1, 17, 22, 16, 402, DateTimeKind.Utc).AddTicks(4900));
            ...
            modelBuilder.Entity("API.DBAccess.Entities.AttributeHistory", b =>
                {
                    ...
                    b.Property<DateTime>("ModDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2022, 9, 1, 17, 22, 16, 402, DateTimeKind.Utc).AddTicks(5366));
            ...
            modelBuilder.Entity("API.DBAccess.Entities.Category", b =>
                {
                    ...
                    b.Property<DateTime>("ModDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2022, 9, 1, 17, 22, 16, 402, DateTimeKind.Utc).AddTicks(5866));
            ...
            modelBuilder.Entity("API.DBAccess.Entities.CategoryAttribute", b =>
                {
                    ...
                    b.Property<DateTime>("ModDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2022, 9, 1, 17, 22, 16, 402, DateTimeKind.Utc).AddTicks(6318));
            ...
            modelBuilder.Entity("API.DBAccess.Entities.CategoryAttributeHistory", b =>
                {
                    ...
                    b.Property<DateTime>("ModDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2022, 9, 1, 17, 22, 16, 402, DateTimeKind.Utc).AddTicks(7319));
            ...
            modelBuilder.Entity("API.DBAccess.Entities.CategoryHistory", b =>
                {
                    ...
                    b.Property<DateTime>("ModDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2022, 9, 1, 17, 22, 16, 402, DateTimeKind.Utc).AddTicks(6824));
            ...
            modelBuilder.Entity("API.DBAccess.Entities.Discount", b =>
                {
                    ...
                    b.Property<DateTime>("ModDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2022, 9, 1, 17, 22, 16, 402, DateTimeKind.Utc).AddTicks(8836));
            ...
            modelBuilder.Entity("API.DBAccess.Entities.ProductAmount", b =>
                {
                    ...
                    b.Property<DateTime>("ModDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2022, 9, 1, 17, 22, 16, 402, DateTimeKind.Utc).AddTicks(8341));
            ...
            modelBuilder.Entity("API.DBAccess.Entities.ShippingAddress", b =>
                {
                    ...
                    b.Property<DateTime>("ModDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2022, 9, 1, 17, 22, 16, 402, DateTimeKind.Utc).AddTicks(3809));
            ...
            modelBuilder.Entity("API.DBAccess.Entities.ShippingAddressHistory", b =>
                {
                    ...
                    b.Property<DateTime>("ModDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2022, 9, 1, 17, 22, 16, 402, DateTimeKind.Utc).AddTicks(4276));
            ...
            modelBuilder.Entity("API.DBAccess.Entities.UserAgreement", b =>
                {
                    ...
                    b.Property<DateTime>("ModDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2022, 9, 1, 17, 22, 16, 402, DateTimeKind.Utc).AddTicks(2750));
            ...
            modelBuilder.Entity("API.DBAccess.Entities.UserAgreementHistory", b =>
                {
                    ...
                    b.Property<DateTime>("ModDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2022, 9, 1, 17, 22, 16, 402, DateTimeKind.Utc).AddTicks(3245));
            ...
            modelBuilder.Entity("API.DBAccess.Entities.Warehouse", b =>
                {
                    ...
                    b.Property<DateTime>("ModDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2022, 9, 1, 17, 22, 16, 402, DateTimeKind.Utc).AddTicks(7891));
